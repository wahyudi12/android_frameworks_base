...
open class LandscapeBatteryDrawable(private val context: Context, frameColor: Int) : Drawable() {
    ...
    override fun draw(c: Canvas) {
        ...
        if (!charging && batteryLevel < 100 && showPercent) {
            ...
            val pctX = bounds.height() * 0.5f
            val pctY = (bounds.width() + textHeight) * 0.5f
    ...
    private fun updateSize() {
        ...
        if (b.isEmpty) {
            ...
            scaleMatrix.setScale((b.right / HEIGHT), (b.bottom / WIDTH))
        }
        ...
        val scaledStrokeWidth =
                Math.max(b.right / HEIGHT * PROTECTION_STROKE_WIDTH, PROTECTION_MIN_STROKE_WIDTH)
