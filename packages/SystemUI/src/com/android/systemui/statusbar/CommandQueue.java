...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_SET_BLOCKED_GESTURAL_NAVIGATION   = 57 << MSG_SHIFT;
    ...
    private static final int MSG_SCREEN_PINNING_STATE_CHANGED      = 93 << MSG_SHIFT;
    private static final int MSG_LEFT_IN_LANDSCAPE_STATE_CHANGED   = 94 << MSG_SHIFT;
