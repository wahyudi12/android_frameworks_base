...
import com.android.systemui.nad.NotificationLightsView;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LOCKSCREEN_ENABLE_QS),
                    false, this, UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            mStatusBarShownOnSecureKeyguard = Settings.System.getIntForUser(
                    resolver, Settings.System.LOCKSCREEN_ENABLE_QS, 1,
                    UserHandle.USER_CURRENT) == 1;
            mOneFingerQuickSettingsIntercept = Settings.Secure.getIntForUser(
                    resolver, Settings.Secure.STATUS_BAR_QUICK_QS_PULLDOWN, 0,
